...
public class LoadingLayout extends FrameLayout {
    ...
    private int mErrorImageMaxHeight;
    private int mErrorImageMaxWidth;
    private int mEmptyImageMaxHeight;
    private int mEmptyImageMaxWidth;
    ...
    public LoadingLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mErrorImageMaxHeight = a.getDimensionPixelSize(R.styleable.LoadingLayout_llErrorImageMaxHeight, dp2px(160));
        mErrorImageMaxWidth = a.getDimensionPixelSize(R.styleable.LoadingLayout_llErrorImageMaxWidth, dp2px(150));

        mEmptyImageMaxHeight = a.getDimensionPixelSize(R.styleable.LoadingLayout_llEmptyImageMaxHeight, dp2px(160));
        mEmptyImageMaxWidth = a.getDimensionPixelSize(R.styleable.LoadingLayout_llEmptyImageMaxWidth, dp2px(150));
        a.recycle();
    }
    ...
    private View layout(int layoutId) {
        ...
        if (layoutId == mEmptyResId) {
            ...
            if (img != null) {
                ...
                img.setMaxHeight(mEmptyImageMaxHeight);
                img.setMaxWidth(mEmptyImageMaxWidth);
            }
            ...
            if (img != null) {
                ...
                img.setMaxHeight(mErrorImageMaxHeight);
                img.setMaxWidth(mErrorImageMaxWidth);
            }
