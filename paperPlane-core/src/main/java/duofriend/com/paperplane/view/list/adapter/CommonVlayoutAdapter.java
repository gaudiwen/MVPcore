...
public abstract class CommonVlayoutAdapter<T> extends DelegateAdapter.Adapter<ViewHolder> {
    ...
    public CommonVlayoutAdapter(Context context) {
        this.context = context;
        this.inflater = LayoutInflater.from(context);
        this.mDatas = new ArrayList<>();
    }

    public CommonVlayoutAdapter(Context context, int layoutId) {
        this.context = context;
    ...
    public CommonVlayoutAdapter(Context context, int layoutId, boolean hasFooterMore) {
        this.context = context;
        this.layoutId = layoutId;
        this.inflater = LayoutInflater.from(context);
        this.mDatas = new ArrayList<>();
    ...
    private boolean isHeaderView(int position) {
        return mHeanderView != null && getItemCount() > 1 && position == 0;
    }
