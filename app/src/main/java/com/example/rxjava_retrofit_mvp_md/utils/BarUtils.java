...
import com.example.rxjava_retrofit_mvp_md.delegates.Utils;
...
public final class BarUtils {
    ...
    public int getNavigationBarHeight() {
        boolean hasMenuKey = ViewConfiguration.get(com.example.rxjava_retrofit_mvp_md.delegates.Utils.getContext()).hasPermanentMenuKey();
